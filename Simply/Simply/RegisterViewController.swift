...
class RegisterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        leftline.path = UIBezierPath(roundedRect: CGRect(x: 25, y: 465, width: 123, height: 1), cornerRadius: 0).cgPath
        ...
        rightline.path = UIBezierPath(roundedRect: CGRect(x: 227, y: 465, width: 123, height: 1), cornerRadius: 0).cgPath
